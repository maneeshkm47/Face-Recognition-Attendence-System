...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"images\face_recognition.jpeg") 
        ...
        # second image 
        img1=Image.open(r"C:\Users\PC\Desktop\Face_recognition_system_ DBMS\images\facial_recognition1.webp") 
        ...
        # third image 
        img2=Image.open(r"images\face_recognition2.jpeg") 
        ...
        #student button
        img4=Image.open(r"images\students.jpeg") 
        img4=img4.resize((220,220),Image.ANTIALIAS)               
        self.photoimg4=ImageTk.PhotoImage(img4)

        b1=Button(bg_img,image=self.photoimg4,command=self.student_details,cursor="hand2")
        b1.place(x=125,y=70,width=220,height=220)
        ...
        b1.place(x=125,y=270,width=220,height=40)

        #Detect face button
        img5=Image.open(r"images\face_detection.png") 
        img5=img5.resize((220,220),Image.ANTIALIAS)               
        self.photoimg5=ImageTk.PhotoImage(img5)

        b1=Button(bg_img,image=self.photoimg5,cursor="hand2",command=self.face_data)
        b1.place(x=425,y=70,width=220,height=220)

        b1=Button(bg_img,text="Face Detection",cursor="hand2",command=self.face_data,font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b1.place(x=425,y=270,width=220,height=40)
        ...
        b1.place(x=725,y=70,width=220,height=220)
        ...
        b1.place(x=725,y=320,width=220,height=220)
        ...
        b1.place(x=725,y=520,width=220,height=40) 

        #Exit face butoon 
        img11=Image.open(r"images\Glass_exit_sign.jpg") 
        img11=img11.resize((220,220),Image.ANTIALIAS)               
        self.photoimg11=ImageTk.PhotoImage(img11)

        b1=Button(bg_img,image=self.photoimg11,cursor="hand2",command=self.iExit)
        b1.place(x=1025,y=320,width=220,height=220)

        b1=Button(bg_img,text="Exit",cursor="hand2",command=self.iExit,font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b1.place(x=1025,y=520,width=220,height=40)
