...
class Attendence:
    def __init__(self, root):
        ...
        # first image
        img=Image.open(r"images\PES_UNIVERSITY.jpeg") 
        ...
        # second image 
        img1=Image.open(r"images\pes_university.png") 
        ...
        bg_img.place(x=-10,y=200,width=1530,height=710)
        ...
        img_left=Image.open(r"images\face_recognition2.jpeg") 
