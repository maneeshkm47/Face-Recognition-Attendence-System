...
class Face_Recognition:
    def __init__(self, root):
        ...
        # buttom
        b1=Button(f_lb1,text="Face Recognition",command=self.face_recog,cursor="hand2",font=("times new roman",15,"bold"),bg="darkgreen",fg="white")
        b1.place(x=250,y=550,width=200,height=40)

    #===========attendence==========
    def mark_attendance(self,i,r,n,d):
        with open("mv.csv","r+",newline="\n") as f:
